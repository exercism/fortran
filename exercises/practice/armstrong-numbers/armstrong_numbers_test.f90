! The tests were created from https://github.com/exercism/problem-specifications/blob/main/exercises/armstrong-numbers/canonical-data.json
...
program armstrong_numbers_test_main
   ...
   ! Test 3: There are no two-digit Armstrong numbers
   call assert_equal(.false., isArmstrongNumber(10), "There are no two-digit Armstrong numbers")
