! The tests were created from https://github.com/exercism/problem-specifications/blob/main/exercises/hamming/canonical-data.json
...
program hamming_test_main
   ...
   call assert_equal(0, distance, "long identical strands, distance=0")
