...
The tests are in `hamming_test.f90` and they expect the implementation to be in `hamming.f90`.
In case the file `hamming.f90` does not exist, create the file with the content:
